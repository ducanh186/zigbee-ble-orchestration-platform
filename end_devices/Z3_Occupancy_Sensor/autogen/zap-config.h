...
#define GENERATED_ATTRIBUTES { \
  { 0x0000, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x08  } }, /* 0 Cluster: Basic, Attribute: ZCL version, Side: server*/ \
		  ...
		  { 0x0000, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 3 Cluster: Occupancy Sensing, Attribute: occupancy, Side: server*/ \
		  { 0x0001, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x03  } }, /* 4 Cluster: Occupancy Sensing, Attribute: occupancy sensor type, Side: server*/ \
		  { 0x0002, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x04  } }, /* 5 Cluster: Occupancy Sensing, Attribute: occupancy sensor type bitmap, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)1  } } /* 6 Cluster: Occupancy Sensing, Attribute: cluster revision, Side: server*/ \
		 }
...
#define GENERATED_CLUSTERS { \
  { 0x0000, (EmberAfAttributeMetadata*)&(generatedAttributes[0]), 3, 0, CLUSTER_MASK_SERVER, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: server*/ \
	  { 0x0406, (EmberAfAttributeMetadata*)&(generatedAttributes[3]), 4, 5, CLUSTER_MASK_SERVER, NULL } /* 1, Endpoint Id: 1, Cluster: Occupancy Sensing, Side: server*/ \
	 }
...
#define ZCL_USING_OCCUPANCY_ATTRIBUTE
#define ZCL_USING_OCCUPANCY_SENSOR_TYPE_ATTRIBUTE
#define ZCL_USING_OCCUPANCY_SENSOR_TYPE_BITMAP_ATTRIBUTE
