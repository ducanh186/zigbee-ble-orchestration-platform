...
void emberAfPluginGreenPowerClientClearProxyTableCommand(sl_cli_command_arg_t *arguments);
...
static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_client_clear_hyphen_proxy_hyphen_table = \
  SL_CLI_COMMAND(emberAfPluginGreenPowerClientClearProxyTableCommand,
...
static const sl_cli_command_info_t cli_cmd_zll_hyphen_commissioning_reset = \
  SL_CLI_COMMAND(emberAfZllResetToFactoryNewCommand,
