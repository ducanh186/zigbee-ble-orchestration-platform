...
PROFILES: dict[str, str] = {
    ...
    "gateway/Z3GatewayHost": "Host-side Z3Gateway app: MQTT -> cmd_handler -> device dispatch -> Ember AF.",
    "gateway/Z3GatewayHost/app": "C modules. Refactor target: app_mqtt.c, cmd_handler.c (parse+dispatch only), device_registry, device_dispatch, light_ctrl, switch_logic.",
